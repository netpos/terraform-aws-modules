...
resource "aws_route" "route" {
  ...
  destination_cidr_block = aws_vpc_peering_connection_accepter.peering_connection_accepter.requester.destination_cidr_block
  vpc_peering_connection_id = aws_vpc_peering_connection_accepter.peering_connection_accepter.id
}
